...
from function import motor_fault_cost as motor
from function import impeller_fault_cost as impeller
...
for _ in range(simulation_times):
    ...
    total_LCC = 591.9222 + seal_fault_cost + motor_fault_cost + impeller_fault_cost
